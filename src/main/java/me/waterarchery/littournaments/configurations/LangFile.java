...
public class LangFile extends OkaeriConfig {
    ...
    private String noPermission = "<white> <#CCFFEE>You don't have enough <#47D4FF>permission to execute <#CCFFEE>this command.";
    private String configReloaded = "<white> <#47D4FF>Config and lang files reloaded successfully.";
    private String inGameOnly = "<white> <#CCFFEE>You can only use this command from <#47D4FF>in-game.";
    private String notOnlinePlayer = "<white> <#CCFFEE>Player is not in the server.";
    private String unknownCommand = "<white> <#CCFFEE>There is <#47D4FF>no command <#CCFFEE>with this <#47D4FF>sub command.";
    private String tooManyArgs = "<white> <#CCFFEE>You entered <#47D4FF>too many arguments <#CCFFEE>for this command.";
    private String tooFewArgs = "<white> <white> <#CCFFEE>You entered <#47D4FF>too few arguments <#CCFFEE>for this command.";
    private String invalidArg = "<white> <#CCFFEE>You entered a <#47D4FF>invalid argument <#CCFFEE>for this command.";
    private String noTournamentWithName = "<white> <#CCFFEE>There is <#47D4FF>no tournament <#CCFFEE>with this name!";
    private String joinFirst = "<white> <#CCFFEE>You need to <#47D4FF>join this tournament <#CCFFEE>before leaving!";
    private String alreadyJoined = "<white> <#CCFFEE>You already <#47D4FF>joined this tournament!";
